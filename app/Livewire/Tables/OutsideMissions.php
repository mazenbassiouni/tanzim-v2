...
class OutsideMissions extends Component implements HasForms, HasTable
{
    use InteractsWithTable;
    use InteractsWithForms;

    public $category_id = Category::OUTSIDE_MISSION;
    ...
    {
        return view('livewire.tables.outside-missions');
    }
}
