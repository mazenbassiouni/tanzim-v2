...
class InsideAttached extends Component implements HasForms, HasTable
{
    use InteractsWithTable;
    use InteractsWithForms;

    public $category_id = Category::INSIDE_ATTACHED;
    ...
    {
        return view('livewire.tables.inside-attached');
    }
}
