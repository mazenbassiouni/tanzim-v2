...
class SpecialitiesPeaceWarReport extends Page implements HasTable
{
    use InteractsWithTable, HasPageShield;

    protected static string $view = 'filament.pages.specialities-peace-war-report';

    protected static ?string $navigationGroup = 'يوميات';

    protected static ?int $navigationSort = 20;

    protected static ?string $navigationLabel = 'التخصصات سلم وحرب';

    protected static ?string $title = 'يومية التخصصات سلم وحرب';
